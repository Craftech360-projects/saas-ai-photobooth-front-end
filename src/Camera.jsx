...
function Camer() {
    ...
    >
      ...
      {isGender && !isThemeSelected && !showScene && (
                ...
                >
                  ...
                  <h1 className="mb-8 semi-bold text-white text-6xl">Select your theme</h1>
                    {/* style={{ 
      ...
      {isCameraOn && (
        <div className="text-center w-screen h-screen flex flex-col justify-center items-center bg-no-repeat">
          <div className="text-center text-6xl font-semibold mb-6  text-white">Strike a Pose</div>
  ...
  className="w-[565px] h-[294px] cursor-pointer  absolute top-[73%]"
>
